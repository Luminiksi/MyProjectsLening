...
import main.try_2.hometasks.lesson_8.GeometryCalculator;
...
public class TestIsTrianglePossible {
    ...
    void testIsTriangleRightAngledWithWrongPositiveSides1() {
        Assertions.assertFalse(GeometryCalculator.isTrianglePossible(5, 6, 30));
    }
    ...
    void testIsTriangleRightAngledWithWrongPositiveSides2() {
        Assertions.assertFalse(GeometryCalculator.isTrianglePossible(3, 40, 20));
    }
    ...
    void testIsTriangleRightAngledWithWrongPositiveSides3() {
        Assertions.assertFalse(GeometryCalculator.isTrianglePossible(25, 4, 7));
    }
    ...
    void testIsTrianglePossibleWithRightPositiveSides() {
        Assertions.assertTrue(GeometryCalculator.isTrianglePossible(3, 4, 5));
    }
    ...
    void testIsTrianglePossibleWithNegativeSides() {
        Assertions.assertFalse(GeometryCalculator.isTrianglePossible(-1, -20, -40));
    }
    ...
    void testIsTrianglePossibleWithOneNegativeSideAndTwoPositiveSides() {
        Assertions.assertFalse(GeometryCalculator.isTrianglePossible(-3, 4, 5));
    }
    ...
    void testIsTrianglePossibleWithZeroSides() {
        Assertions.assertFalse(GeometryCalculator.isTrianglePossible(0, 0, 0));
    }
    ...
    void testIsTrianglePossibleWithOneZeroSideAndTwoPositiveSides() {
        Assertions.assertFalse(GeometryCalculator.isTrianglePossible(3, 0, 5));
    }
    ...
    void testIsTrianglePossibleWithOneFractionalSideAndTwoPositiveSides() {
        Assertions.assertTrue(GeometryCalculator.isTrianglePossible(1.5, 2, 3));
    }
